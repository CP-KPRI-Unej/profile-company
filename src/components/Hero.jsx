...
const Hero = ({ colorDeep, mainText, shadow, mobileShadow, subText, img }) => {
  return (
    <main
      className={`flex lg:flex-row lg:items-center flex-col items-start px-4 z-10 relative overflow-hidden md:px-16 mt-24`}
    >
      <div className="flex flex-col gap-4 lg:w-1/2 justify-center lg:items-start lg:text-left w-full items-center text-center mb-5 md:mb-0">
        ...
        <p className="leading-normal md:text-2xl text-lg text-navy">
          {subText}
        </p>
        <Button
          type="button"
